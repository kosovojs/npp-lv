<?php
//from https://bitbucket.org/magnusmanske/magnustools/src/master/public_html/php/ToolforgeCommon.php
...
// DATABASE
	...
	public function openDBtool ( $dbname = '' , $server = '' , $force_user = '' , $persistent = false ) {
		...
		$db = new SimpleMySQLi($server, $this->mysql_user, $this->mysql_password, $dbname, "utf8mb4", "assoc");//@new mysqli($server, $this->mysql_user, $this->mysql_password , $dbname);
